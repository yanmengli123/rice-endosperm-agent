...
/**
 * Repairs only unmistakable GFM table blocks. Cell values are never inferred,
 * merged, or removed; missing syntax cells are padded deterministically.
 */
export const normalizeMarkdownTables = (content) => {
